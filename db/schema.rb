...
ActiveRecord::Schema[8.0].define(version: 2025_02_23_155007) do
  ...
  create_table "character_portraits", force: :cascade do |t|
    t.bigint "character_id", null: false
    t.boolean "selected", default: false, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.text "generation_prompt"
    t.index ["character_id", "selected"], name: "index_character_portraits_on_character_id_and_selected", unique: true, where: "(selected = true)"
    t.index ["character_id"], name: "index_character_portraits_on_character_id"
  end
  ...
  create_table "characters", force: :cascade do |t|
    ...
    t.text "background"
    t.jsonb "image_metadata", default: {}, null: false
    t.string "race"
    t.jsonb "character_values", default: {"bonds"=>[], "flaws"=>[], "ideals"=>[]}
    t.jsonb "character_traits", default: []
    t.text "personality_traits", default: [], array: true
    t.jsonb "personality_details", default: {"bonds"=>[], "flaws"=>[], "ideals"=>[]}
    t.index ["character_traits"], name: "index_characters_on_character_traits", using: :gin
    t.index ["character_values"], name: "index_characters_on_character_values", using: :gin
    t.index ["image_status"], name: "index_characters_on_image_status"
  ...
  add_foreign_key "character_portraits", "characters"
